        ...
        <div className="p-8 rounded-3xl bg-[#12141C] border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.6)] space-y-6">
          <div className="text-center space-y-1.5">
            ...
            <p className="text-xs sm:text-sm text-slate-400">
              Get 20 viral AI videos for just $49/month
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              type="button"
              className="py-2.5 px-4 rounded-2xl bg-[#181B26] hover:bg-[#202534] border border-white/5 text-xs font-semibold text-white flex items-center justify-center gap-2 transition-all"
            >
          ...
          <form onSubmit={handleMockSignUp} className="space-y-4">
            ...
            {/* Starter Plan Included Badge */}
            <div className="p-3 rounded-2xl bg-[#0E1017] border border-white/5 flex items-center justify-between text-xs">
              <div className="flex items-center gap-2">
                <Check className="w-4 h-4 text-emerald-400" />
                <span className="text-slate-300">Starter Plan (20 Videos/mo)</span>
              </div>
              <span className="font-bold text-white font-mono">$49/mo</span>
            </div>
