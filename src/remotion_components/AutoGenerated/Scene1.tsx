...
export const GeneratedScene1: React.FC = () => {
    ...
    <AbsoluteFill style={{
      ...
      <div style={{
        ...
        <div style={{fontSize: 22, color: '#F59E0B', fontWeight: 'bold', marginBottom: 16, letterSpacing: 1}}>
          ✨ VAULT STYLE // CHRON_STYLE_27 // SCENE 01
        </div>
        <h1 style={{fontSize: 54, fontWeight: 'bold', color: '#38BDF8', lineHeight: 1.2, marginBottom: 24}}>
          A 40-YEAR-OLD GOALKEEPER JUST DID THEM P
        </h1>
        <p style={{fontSize: 28, color: '#94A3B8', lineHeight: 1.5}}>
          "A 40-year-old goalkeeper just did them possible at the World Cup and gave 11 million followers overnight. This happened "
        </p>
      </div>
    </AbsoluteFill>
  );
